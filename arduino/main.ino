...
// Nécessité de créer un compte TTN ainsi qu'une application sur le portail, et de lier le device utilisé à l'application
const char *DEV_ADDR = ""; // TTN (the things network) credentials
const char *NWK_SKEY = ""; // TTN (the things network) credentials
const char *APP_SKEY = ""; // TTN (the things network) credentials
